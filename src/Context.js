...
const initialState = {
  ...
  menus: [
    ...
    { id: 2, name: "Ma Présentation", href: "about" },
    // { id: 3, name: "Mon Savoir-Faire", href: "service" },
    // { id: 4, name: "Portfolio en Images", href: "portfolio" },
    { id: 5, name: "Me Contacter", href: "contact" },
  ],
};
