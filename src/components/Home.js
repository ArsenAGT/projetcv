          ...
          <div className="home_content flex items-center">
            ...
            >
              ...
              <div
                ...
                data-img-url="assets/img/slider/arsen2.jpg"
              />
            </div>
            <div className="details ml-[80px]">
              <h3 className="name text-[55px] font-extrabold uppercase mb-[14px]">
                Arsen <span>GASPAROV</span>
              </h3>
              <p className="job font-montserrat font-medium max-w-[450px] mb-[25px]">
                Passionné d'informatique depuis toujours, je relève des défis complexes et apporte des solutions concrètes grâce à mes compétences autodidactes et mon expérience professionnelle.
              </p>
